...
def main(dataset, tar_test_dataset, input_model_file, gnn_type, add_similarity, add_selfsupervise, add_masking, add_weight, m_support):
    # Training settings
    ...
    elif args.dataset == 'BZR' or args.dataset == 'COX2' or args.dataset == 'MUTAG' or args.dataset == 'PROTEINS':
        args.num_tasks = 4
    ...
    if args.tar_test_dataset == 'BZR' or args.tar_test_dataset == 'COX2' or args.tar_test_dataset == 'MUTAG' or args.tar_test_dataset == 'PROTEINS':
    ...
    for epoch in range(1, args.epochs+1):
        ...
        if epoch % 1 == 0:
            ...
            # fw.write("\n")
            # fw.close()
    final_test_auc = model.final_test(support_grads)
    print('Final AUC:', final_test_auc)

if __name__ == "__main__":
    # dataset, pretrained_model, graph_model, taskaware_attention, edge_pred, atom_pred, weight, #support 
    main("BZR", "COX2", "model_gin/supervised_contextpred.pth", "gin", True, True, True, 0.1, 5)
