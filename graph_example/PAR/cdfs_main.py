...
from chem_lib.models.cdfs_trainer import CDFS_Trainer
from chem_lib.models.cdfs.cdfs_model import PrototypicalNetworkModel
...
def main():
    ...
    for combo in valid_combinations:
        ...
        for repeat in range(1, num_repeats + 1):
            ...
            model = PrototypicalNetworkModel(args)
            count_model_params(model)
            model = model.to(args.device)

            # Initialize trainer
            trainer = CDFS_Trainer(args, model)
