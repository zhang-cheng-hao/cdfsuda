...
def get_parser(root_dir='.'):
    ...
    parser.add_argument('-d', '--dataset', type=str, default='BZR', help='data set name')  # [BZR, COX2, MUTAG, PROTEINS, tox21]
    parser.add_argument('-td', '--test-dataset', type=str, default='BZR',
                        help='test data set name') # [BZR, COX2, MUTAG, PROTEINS, tox21]
    parser.add_argument('-ttd', '--tar-test-dataset', type=str, default='tox21', # [BZR, COX2, MUTAG, PROTEINS, tox21]
                        help='tar test data set name')  # ['tox21','sider','muv','toxcast']
    ...
    # num class
    parser.add_argument("--n-class", type=int, default=2, help="number of class,default is the num_class of apache")
    ...
    # model
    ## cdtc
    parser.add_argument('--input_emb_dim', type=int, default=64, help='input embedding dimensions')
    parser.add_argument('--cdtc_hidden_dim', type=int, default=32, help='hidden dimensions')
    parser.add_argument('--cdtc_embedding_dim', type=int, default=64, help='embedding dimensions')
    parser.add_argument('--cdtc_proto_dim', type=int, default=64, help='proto dimensions')
    parser.add_argument('--cdtc_refined_dim', type=int, default=64, help='refined dimensions')
    parser.add_argument('--delta', type=float, default=0.5, help='delta')
    parser.add_argument('--num_tasks_to_select', type=int, default=2, help='number of meta tasks to select')

    ## cdfs
    parser.add_argument('--d_x', type=int, default=128, help='Hyperparameter, dimension of eigenvector X')
    parser.add_argument('--d_u', type=int, default=128, help='Hyperparameter, dimension of eigenvector U')
    parser.add_argument('--d_z', type=int, default=24, help='Hyperparameter, dimension of eigenvector z')
    parser.add_argument('--d_h', type=int, default=12, help='Hyperparameter, dimension of eigenvector h')
...
def get_args(root_dir='.', args = None, is_save=True):
    if args == None:
    ...
    _,tar_test_tasks =  obatin_train_test_tasks(args.tar_test_dataset)
