...
from graph_lib.models.cdfs.augmentation import GraphAugmentation
...
class PrototypicalNetworkModel(nn.Module):
    ...
    def forward(self, s_data, q_data, s_label=None, q_pred_adj=False):
        ...
        # Encode support and query graphs
        ...
        # Here, adj is a placeholder for adjacency information that might be used in your context
        # It is not computed in this example as it depends on the specifics of your task
        adj = None
        s_emb = None
        return s_h, q_h, adj, s_emb
    ...
    def compute_prototypical_logits(self, q_h, s_h, s_label):
        device = q_h.device
        num_classes = len(torch.unique(s_label))
    ...
    def forward_query_loader(self, s_data, q_loader, s_label=None, q_pred_adj=False):
        ...
        return s_h, q_logits, y_true, adj_list, sup_labels
